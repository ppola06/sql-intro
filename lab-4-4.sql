...
SELECT teams.name, players.first_name, players.last_name, MAX(stats.home_runs) FROM players JOIN stats ON players.id = stats.player_id JOIN teams ON teams.id = stats.team_id WHERE teams.year = 2019 GROUP BY 1;
